            ...
            <div className={wantm.backimg}>
                <div  className='d-flex flex-column justify-content-center align-items-center'>
                    ...
                    <div className={`${wantm.glassmorphism} d-flex flex-column justify-content-center align-items-center text-start`}>
                        <div className={`${wantm.glassdiv} d-flex flex-column justify-content-center text-start `}>
                            <p className='text mb-3 d-flex align-items-md-start align-items-center'>
                                <img src='./img/quickmenu.png' className={`${wantm.imgsize} me-3`} />
                                어떤 미디어를 보고싶나요? (장르 무관)
                            </p>
                            <div className={`${wantm.mediaform} mb-3 d-flex justify-content-center  align-items-center`}>
                                <input type="text" className="d-block" placeholder="보고싶은 미디어를 작성해주세요" />
                            </div>
                            <p className='text d-flex align-items-md-start align-items-center'>
                                <img src='./img/quickmenu.png' className={`${wantm.imgsize} me-3`} />
                                신청하신 미디어가 업로드 되면 소정의 상품과 함께 알려드릴게요!
                            </p>
                            <p className='text ms-5 mb-3 d-flex align-items-md-start align-items-center'>성함과 전화번호를 알려주세요.</p>
                            <div className={`${wantm.mediaform} mb-3 d-flex justify-content-center align-items-center`}>
                                <input type="text" className="d-block" placeholder="예시 : 홍길동 / 010-1234-5678" />
                            </div>
